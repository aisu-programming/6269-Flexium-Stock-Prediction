...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='combined_rm_front.csv', help='data file')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.000015, help='optimizer learning rate')
    parser.add_argument('--lradj', type=str, default='1.07', help='adjust learning rate')
